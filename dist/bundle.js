"use strict";/***** NEW VERSION SAFARI 2*/ /******/(()=>{// webpackBootstrap
/******/var __webpack_modules__={/***/"./src/js/Game.js":/*!************************!*\
  !*** ./src/js/Game.js ***!
  \************************/ /***/(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{"use strict";__webpack_require__.r(__webpack_exports__);/* harmony export */__webpack_require__.d(__webpack_exports__,{/* harmony export */"Game":()=>/* binding */Game/* harmony export */});/* harmony import */var _display__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(/*! ./display */"./src/js/display.js");/* harmony import */var _utilities__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__(/*! ./utilities */"./src/js/utilities.js");/* provided dependency */var $=__webpack_require__(/*! jquery */"./node_modules/jquery/dist/jquery.js");function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}function _createClass(Constructor,protoProps,staticProps){if(protoProps)_defineProperties(Constructor.prototype,protoProps);if(staticProps)_defineProperties(Constructor,staticProps);Object.defineProperty(Constructor,"prototype",{writable:false});return Constructor;}function _classPrivateMethodInitSpec(obj,privateSet){_checkPrivateRedeclaration(obj,privateSet);privateSet.add(obj);}function _checkPrivateRedeclaration(obj,privateCollection){if(privateCollection.has(obj)){throw new TypeError("Cannot initialize the same private elements twice on an object");}}function _classPrivateMethodGet(receiver,privateSet,fn){if(!privateSet.has(receiver)){throw new TypeError("attempted to get private field on non-instance");}return fn;}var _play=/*#__PURE__*/new WeakSet();var _checkMatch=/*#__PURE__*/new WeakSet();var _displayMultiplayerScore=/*#__PURE__*/new WeakSet();var _whosTurn=/*#__PURE__*/new WeakSet();var _setupPlayersData=/*#__PURE__*/new WeakSet();var _generateGamePlay=/*#__PURE__*/new WeakSet();var _generatePlayerDisplay=/*#__PURE__*/new WeakSet();var _generateIds=/*#__PURE__*/new WeakSet();var _updateMoves=/*#__PURE__*/new WeakSet();var Game=/*#__PURE__*/function(){function Game(theme,_players,_grid){_classCallCheck(this,Game);_classPrivateMethodInitSpec(this,_updateMoves);_classPrivateMethodInitSpec(this,_generateIds);_classPrivateMethodInitSpec(this,_generatePlayerDisplay);_classPrivateMethodInitSpec(this,_generateGamePlay);_classPrivateMethodInitSpec(this,_setupPlayersData);_classPrivateMethodInitSpec(this,_whosTurn);_classPrivateMethodInitSpec(this,_displayMultiplayerScore);_classPrivateMethodInitSpec(this,_checkMatch);_classPrivateMethodInitSpec(this,_play);this.theme=theme;this.players=_players;this.grid=_grid;this.ids=null;this.first=null;this.second=null;this.playersData=[];this.playersTurn=0;this.iconsFound=[];}_createClass(Game,[{key:"generateGamePlay",value:function generateGamePlay(){_classPrivateMethodGet(this,_generateGamePlay,_generateGamePlay2).call(this,this.grid);_classPrivateMethodGet(this,_setupPlayersData,_setupPlayersData2).call(this);_classPrivateMethodGet(this,_play,_play2).call(this);}},{key:"getWinners",value:function getWinners(){this.playersData[0].winner=true;for(var i=0;i<this.playersData.length;i++){if(i===this.playersData.length){return;}if(this.playersData[0].score===this.playersData[i].score){this.playersData[i].winner=true;}}}}]);return Game;}();function _play2(){var _this=this;$("#grid-container").on("click",function(e){if(!$(e.target).hasClass("icon-holder")){return;}if(_this.iconsFound.includes($(e.target).data("id"))){return;}if(_this.first===null&&_this.second===null){_this.first=$(e.target).data("id");$(e.target).addClass("icon-pending");if(_this.theme==="numbers"){$(e.target).children("h4").removeClass("hidden");}else{$(e.target).children("img").removeClass("hidden");}}else if(_this.first!=null&&_this.second===null){_this.second=$(e.target).data("id");$(e.target).addClass("icon-pending");if(_this.theme==="numbers"){$(e.target).children("h4").removeClass("hidden");}else{$(e.target).children("img").removeClass("hidden");}_classPrivateMethodGet(_this,_checkMatch,_checkMatch2).call(_this);}});}function _checkMatch2(){var _this2=this;_classPrivateMethodGet(this,_updateMoves,_updateMoves2).call(this);//displayFinalScore(this)
if(this.first===this.second){$("*[data-id=\"".concat(this.first,"\"]")).removeClass("icon-pending, hover:bg-[#6395B8]");$("*[data-id=\"".concat(this.first,"\"]")).addClass("icon-matched");this.playersData[this.playersTurn].score+=1;this.iconsFound.push(this.first);_classPrivateMethodGet(this,_whosTurn,_whosTurn2).call(this,true);if(this.iconsFound.length==this.grid*this.grid/2){_classPrivateMethodGet(this,_displayMultiplayerScore,_displayMultiplayerScore2).call(this);(0,_display__WEBPACK_IMPORTED_MODULE_0__.displayFinalScore)(this);return;}}else{setTimeout(function(){$("*[data-id=\"".concat(_this2.first,"\"]")).removeClass("icon-pending");$("*[data-id=\"".concat(_this2.first,"\"]")).children("h4, img").addClass("hidden");$("*[data-id=\"".concat(_this2.second,"\"]")).removeClass("icon-pending");$("*[data-id=\"".concat(_this2.second,"\"]")).children("h4, img").addClass("hidden");},500);_classPrivateMethodGet(this,_whosTurn,_whosTurn2).call(this);}setTimeout(function(){_classPrivateMethodGet(_this2,_displayMultiplayerScore,_displayMultiplayerScore2).call(_this2);_this2.first=null;_this2.second=null;},600);}function _displayMultiplayerScore2(){if(this.players===1){return;}this.playersData.forEach(function(player){$("#multiplayer-score-".concat(player.playerID)).text(player.score);});}function _whosTurn2(playAgain){if(playAgain){return;}if(this.playersTurn+1==this.playersData.length){this.playersTurn=0;}else if(this.players===1){this.playersTurn=0;}else{this.playersTurn+=1;}$(".multiplayer-container").removeClass("yourTurn");$("#player-container-".concat(this.playersTurn+1)).addClass("yourTurn");}function _setupPlayersData2(){for(var i=1;i<=this.players;i++){this.playersData.push({playerID:i,score:0,move:0,winner:false});}}function _generateGamePlay2(gridSize){_classPrivateMethodGet(this,_generateIds,_generateIds2).call(this);if(gridSize!=4&&gridSize!=6){return;}var grid=gridSize*gridSize;var html="";$("#grid-container").removeClass("col4, col6");$("#grid-container").addClass("col".concat(gridSize));for(var i=0;i<grid;i++){var index=Math.floor(Math.random()*this.ids.length);var id=this.ids[index];this.ids.splice(index,1);html+="<div class='icon-holder hover:bg-[#6395B8]' id=\"icon-holder-".concat(i+1,"\" data-id='").concat(id,"'>\n                        <h4 class=\"memory-number hidden\">").concat(id,"</h4>\n                        <img class=\"memory-number hidden w-[50%]\" src=\"assets/icons/").concat(id,".svg\">\n                    </div>");}$("#grid-container").append(html);_classPrivateMethodGet(this,_generatePlayerDisplay,_generatePlayerDisplay2).call(this,this.players);if(this.players==1)(0,_utilities__WEBPACK_IMPORTED_MODULE_1__.timer)();}function _generatePlayerDisplay2(players){if(players!=1&&players!=2&&players!=3&&players!=4){return;}var html="";if(players===1){html="<div class=\"w-[25%] bg-[#DFE7EC] py-[17px] px-[24px] sm:flex sm:flex-row justify-between items-center rounded-lg text-center\">\n                        <span class=\"sm:block font-bold font-Aktinson font-xl text-[#7191A5]\">Time</span>\n                        <span class=\"block font-bold font-Aktinson text-2xl text-[#304859]\" id=\"timer-container\"><span id=\"min-timer\">00</span>:<span id=\"sec-timer\">00</span></span>\n                    </div>\n                    <div class=\"w-[25%] bg-[#DFE7EC] py-[17px] px-[24px] sm:flex sm:flex-row justify-between items-center rounded-lg text-center\">\n                        <span class=\"sm:block font-bold font-Aktinson font-xl text-[#7191A5]\">Moves</span>\n                        <span class=\"block font-bold font-Aktinson text-2xl text-[#304859]\" id=\"moves-container\">0</span>\n                    </div>";}else{for(var i=0;i<players;i++){html+="<div id=\"player-container-".concat(i+1,"\" class=\"w-[25%] bg-[#DFE7EC]  py-[17px] px-[24px] sm:flex sm:flex-row justify-between items-center rounded-lg text-center multiplayer-container\">\n                            <span class=\"hidden sm:block font-bold font-Aktinson font-xl text-[#7191A5]\">Player ").concat(i+1,"</span>\n                            <span class=\"block sm:hidden font-bold font-Aktinson font-xl text-[#7191A5]\">P").concat(i+1,"</span>\n                            <span id=\"multiplayer-score-").concat(i+1,"\" class=\"block font-bold font-Aktinson text-2xl text-[#304859]\">0</span>\n                        </div>");}}$("#players-container").append(html);$("#player-container-1").addClass("yourTurn");}function _generateIds2(){var ids=[];var grid=this.grid*this.grid/2;for(var i=0;i<grid;i++){ids.push(i+1);ids.push(i+1);}this.ids=ids;}function _updateMoves2(){this.playersData[this.playersTurn].move+=1;$("#moves-container").text(this.playersData[this.playersTurn].move);}/***/},/***/"./src/js/display.js":/*!***************************!*\
  !*** ./src/js/display.js ***!
  \***************************/ /***/(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{"use strict";__webpack_require__.r(__webpack_exports__);/* harmony export */__webpack_require__.d(__webpack_exports__,{/* harmony export */"displaySetup":()=>/* binding */displaySetup,/* harmony export */"hideSetup":()=>/* binding */hideSetup,/* harmony export */"setupInteraction":()=>/* binding */setupInteraction,/* harmony export */"displayFinalScore":()=>/* binding */displayFinalScore,/* harmony export */"hideFinalScore":()=>/* binding */hideFinalScore/* harmony export */});/* harmony import */var _utilities__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(/*! ./utilities */"./src/js/utilities.js");/* provided dependency */var $=__webpack_require__(/*! jquery */"./node_modules/jquery/dist/jquery.js");var displaySetup=function displaySetup(){$("#starting-game").removeClass("hidden");};var hideSetup=function hideSetup(){$("#starting-game").addClass("hidden");};var setupInteraction=function setupInteraction(game){$("#setup-container").on("click",function(e){if(e.target.localName!="button"){return;}var dataObject=$(e.target).data();var dataKeys=Object.keys(dataObject)[0];switch(dataKeys){case"theme":game.theme=$(e.target).data("theme");$('*[data-theme]').removeClass("active");$(e.target).addClass("active");break;case"players":game.players=$(e.target).data("players");$('*[data-players]').removeClass("active");$(e.target).addClass("active");break;case"grid":game.grid=$(e.target).data("grid");$('*[data-grid]').removeClass("active");$(e.target).addClass("active");break;default:break;}});};var displayFinalScore=function displayFinalScore(game){$("#final-modal, #final-bg-modal").removeClass("hidden");if(game.players===1){(0,_utilities__WEBPACK_IMPORTED_MODULE_0__.pauseTimer)();$("#sec-elapsed").text($("#sec-timer").text());$("#min-elapsed").text($("#min-timer").text());$("#moves-taken").text(game.playersData[0].move);}else{$("#time-elapsed-container").remove();$("#moves-taken-container").remove();$("#final-score-para").text("Game over! Here are the results...");var html=generateScoreContainer(game);$("#score-title").text(generateScoreTitle(game));$(html).insertAfter($("#final-score-para"));}};var generateScoreTitle=function generateScoreTitle(game){var count={};var title="";game.playersData.forEach(function(i){count[i.winner]=(count[i.winner]||0)+1;});if(count["true"]>1){title="It's a tie!";return title;}else{for(var i=0;i<game.playersData.length;i++){if(game.playersData[i].winner===true){title="Player ".concat(game.playersData[i].playerID," Wins!");return title;}}}};var generateScoreContainer=function generateScoreContainer(game){var playersData=game.playersData;playersData.sort(function(a,b){return a.score-b.score;});playersData.reverse();game.getWinners();console.log(game.playersData);var html="";for(var i=0;i<playersData.length;i++){var bg="#DFE7EC";var winner="";var playerColor="[#7191A5]";var pairColor="[#304859]";var pair="Pairs";if(playersData[i].winner===true){bg="#152938";winner="(Winner)";playerColor="white";pairColor="white";}if(playersData[i].score<=1){pair="Pair";}html+="<div class=\"bg-[".concat(bg,"] multi-winner-container\">\n                    <p class=\"sm:text-xl text-lg text-").concat(playerColor,"\">Player ").concat(playersData[i].playerID," ").concat(winner,"</p>\n                    <h6 class=\"sm:text-4xl text-2xl text-").concat(pairColor,"\">").concat(playersData[i].score," ").concat(pair,"</h6>\n                </div>");}return html;};var hideFinalScore=function hideFinalScore(){$("#final-modal, #final-bg-modal").addClass("hidden");};/***/},/***/"./src/js/navbar.js":/*!**************************!*\
  !*** ./src/js/navbar.js ***!
  \**************************/ /***/(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{"use strict";__webpack_require__.r(__webpack_exports__);/* harmony export */__webpack_require__.d(__webpack_exports__,{/* harmony export */"navbar":()=>/* binding */navbar/* harmony export */});/* harmony import */var _utilities__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(/*! ./utilities */"./src/js/utilities.js");/* provided dependency */var $=__webpack_require__(/*! jquery */"./node_modules/jquery/dist/jquery.js");var navbar=function navbar(game){$("#menu-btn").on("click",function(){$("#mobile-menu-bg").removeClass("hidden");$("#mobile-menu").addClass("flex").removeClass("hidden");(0,_utilities__WEBPACK_IMPORTED_MODULE_0__.pauseTimer)();});$("#resume-btn").on("click",function(){$("#mobile-menu-bg").addClass("hidden");$("#mobile-menu").removeClass("flex").addClass("hidden");(0,_utilities__WEBPACK_IMPORTED_MODULE_0__.resumeTimer)();});$("#restart-game-mb").on("click",function(){$("#mobile-menu-bg").addClass("hidden");$("#mobile-menu").removeClass("flex").addClass("hidden");});$('*[data-button="new-game"]').on("click",function(){location.reload();});$('*[data-button="restart-game"]').on("click",function(){sessionStorage.setItem("game",JSON.stringify(game));location.reload();});};/***/},/***/"./src/js/utilities.js":/*!*****************************!*\
  !*** ./src/js/utilities.js ***!
  \*****************************/ /***/(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{"use strict";__webpack_require__.r(__webpack_exports__);/* harmony export */__webpack_require__.d(__webpack_exports__,{/* harmony export */"timer":()=>/* binding */timer,/* harmony export */"pauseTimer":()=>/* binding */pauseTimer,/* harmony export */"resetTimer":()=>/* binding */resetTimer,/* harmony export */"resumeTimer":()=>/* binding */resumeTimer/* harmony export */});/* provided dependency */var $=__webpack_require__(/*! jquery */"./node_modules/jquery/dist/jquery.js");var interval;var timer=function timer(s,m){var sec=s?s:0;var min=m?m:0;interval=setInterval(function(){if(sec>=59){min+=1;sec=0;}sec+=1;var minString;var secString;if(min<10){minString="0"+min.toString();}else{minString=min.toString();}if(sec<10){secString="0"+sec.toString();}else{secString=sec.toString();}$("#min-timer").text(minString);$("#sec-timer").text(secString);},1000);};var pauseTimer=function pauseTimer(){clearInterval(interval);};var resetTimer=function resetTimer(){clearInterval(interval);$("#sec-timer").text("00");$("#min-timer").text("00");};var resumeTimer=function resumeTimer(){var sec=parseInt($("#sec-timer").text());var min=parseInt($("#min-timer").text());timer(sec,min);};/***/},/***/"./node_modules/jquery/dist/jquery.js":/*!********************************************!*\
  !*** ./node_modules/jquery/dist/jquery.js ***!
...
if(typeof noGlobal==="undefined"){window.jQuery=window.$=jQuery;}return jQuery;});/***/}/******/};/************************************************************************/ /******/ // The module cache
...
/******/__webpack_require__.r=exports=>{/******/if(typeof Symbol!=='undefined'&&Symbol.toStringTag){/******/Object.defineProperty(exports,Symbol.toStringTag,{value:'Module'});/******/}/******/Object.defineProperty(exports,'__esModule',{value:true});/******/};/******/})();/******/ /************************************************************************/var __webpack_exports__={};// This entry need to be wrapped in an IIFE because it need to be in strict mode.
(()=>{"use strict";/*!*************************!*\
  !*** ./src/js/index.js ***!
  \*************************/__webpack_require__.r(__webpack_exports__);/* harmony import */var _navbar__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(/*! ./navbar */"./src/js/navbar.js");/* harmony import */var _display__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__(/*! ./display */"./src/js/display.js");/* harmony import */var _Game__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__(/*! ./Game */"./src/js/Game.js");/* provided dependency */var $=__webpack_require__(/*! jquery */"./node_modules/jquery/dist/jquery.js");console.log("Safari!!!");//sessionStorage.clear()
if(sessionStorage.getItem("game")){var value=JSON.parse(sessionStorage.getItem("game"));var game=new _Game__WEBPACK_IMPORTED_MODULE_2__.Game(value.theme,value.players,value.grid);(0,_display__WEBPACK_IMPORTED_MODULE_1__.hideSetup)();game.generateGamePlay();sessionStorage.clear();(0,_navbar__WEBPACK_IMPORTED_MODULE_0__.navbar)(game);}else{var _game=new _Game__WEBPACK_IMPORTED_MODULE_2__.Game("numbers",1,4);(0,_display__WEBPACK_IMPORTED_MODULE_1__.displaySetup)();(0,_display__WEBPACK_IMPORTED_MODULE_1__.setupInteraction)(_game);$("#start-game-btn").on("click",function(){(0,_display__WEBPACK_IMPORTED_MODULE_1__.hideSetup)();_game.generateGamePlay();});(0,_navbar__WEBPACK_IMPORTED_MODULE_0__.navbar)(_game);}})();/******/})();
